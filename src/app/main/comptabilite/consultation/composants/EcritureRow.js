...
export default function EcritureRow(props) {
  ...
  return (
    ...
    >
      ...
      >
        <Typography style={{ fontSize: 16, fontWeight: "bold" }}>
          {ecriture.third && wordElipsis(ecriture.third.raison_social, 150)}
        </Typography>
      </TableCell>
      <TableCell
        width={110}
      ...
      >
        <Typography
          style={{ fontSize: 14, fontWeight: "700", color: "#218277" }}
        >
      ...
      >
        <Typography
          style={{ fontSize: 14, fontWeight: "700", color: "#C53D1B" }}
        >
