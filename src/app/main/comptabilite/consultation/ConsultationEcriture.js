...
function ConsultationEcriture(props) {
  ...
  const ecritures = useSelector(({ consultation }) => consultation.ecritures);
...
export default withReducer("consultation", reducer)(ConsultationEcriture);
