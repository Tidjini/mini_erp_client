...
function InputTable(props) {
  ...
  const collection = useSelector(({ ecriture }) => ecriture.collection);
  const config = useSelector(({ ecriture }) => ecriture.config);
...
export default withReducer("ecriture", reducer)(InputTable);
